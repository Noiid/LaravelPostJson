...
if ($('#percent_fire_fighting').length) {

    zingchart.THEME = "classic";

    // var percent = "ok";
    $.ajax({
        url: '/getPercentFire/FireFighting',
        type: 'get',
        dataType: 'json',
...
if ($('#percent_evacuation').length) {

    zingchart.THEME = "classic";

    $.ajax({
        url: '/getPercentFire/Evacuation',
        type: 'get',
        dataType: 'json',
        success: function (response) {
            percent = response['data'];
...
if ($('#percent_leadership').length) {

    zingchart.THEME = "classic";

    $.ajax({
        url: '/getPercentFire/Leadership',
        type: 'get',
        dataType: 'json',
        success: function (response) {
            percent = response['data'];
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            Highcharts.chart('highpiechart4', {
                ...
                title: {
                    text: 'Type of mistakes Fire Fighting'
                },
                tooltip: {
...
if ($('#highpiechart4_2').length) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            // Build the chart
            Highcharts.chart('highpiechart4_2', {
                chart: {
                    plotBackgroundColor: null,
                    plotBorderWidth: null,
                    plotShadow: false,
                ...
                title: {
                    text: 'Type of mistakes Evacuation'
                },
                tooltip: {
                    pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
                },
...
if ($('#highpiechart4_3').length) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            // Build the chart
            Highcharts.chart('highpiechart4_3', {
                chart: {
                    plotBackgroundColor: null,
                    plotBorderWidth: null,
                    plotShadow: false,
                ...
                title: {
                    text: 'Type of mistakes Leadership'
                },
                tooltip: {
                    pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
                },
