    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            var chart = AmCharts.makeChart("ambarchart4", {
                ...
                "startDuration": 1,
                "graphs": [{
                    "balloonText": "<b>Maximum error : [[value]]</b>",
                    "fillColorsField": "color",
                    "fillAlphas": 0.9,
                    "lineAlpha": 0.2,
                    "type": "column",
