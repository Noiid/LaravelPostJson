...
<body>
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li><a href="maps.html"><i class="ti-map-alt"></i> <span>Training Dashboard</span></a></li>
                            <li><a href="invoice.html"><i class="ti-receipt"></i> <span>Company Dashboard</span></a></li>
                        </ul>
                    </nav>
                </div>
            </div>
    ...
    <script src="{{ asset('https://www.amcharts.com/lib/3/serial.js') }}"></script>
    <script src="{{ asset('https://www.amcharts.com/lib/3/plugins/animate/animate.min.js') }}"></script>
