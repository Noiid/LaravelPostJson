...
<body class="body-bg">
                        ...
                        <div class="horizontal-menu">
                            <nav>
                                <ul id="nav_menu">
                                    ...
                                    <li><a href="/"><i class="ti-map-alt"></i> <span>Training Dashboard</span></a></li>
                                    <li><a href="/company"><i class="ti-map-alt"></i> <span>Company Dashboard</span></a></li>
                                    <li><a href="/logout"><i class="ti-arrow-right"></i> <span>Logout</span></a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
    ...
    <script src="{{ asset('assets/js/my_main.js') }}"></script>
